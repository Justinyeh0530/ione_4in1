...
var XPG_MOUSE_Pos = [
	{ X1: 110, X2: (110+ 72), Y1:156+(28*6), Y2: (156+(28*6)+ 60) },
	{ X1: 110, X2: (110+ 72), Y1:156+(28*5), Y2: (156+(28*5)+ 28) },
	{ X1: 110, X2: (110+ 72), Y1:156+(28*4), Y2: (156+(28*4)+ 28) },
	{ X1: 110, X2: (110+ 72), Y1:156+(28*3), Y2: (156+(28*3)+ 28) },
	{ X1: 110, X2: (110+ 72), Y1:156+(28*2), Y2: (156+(28*2)+ 28) },
	{ X1: 110, X2: (110+ 72), Y1:156+(28*1), Y2: (156+(28*1)+ 28) },

	{ X1: 30, X2: (30+ 72), Y1:156+(28*1), Y2: (156+(28*1)+ 28) },
	{ X1: 30, X2: (30+ 72), Y1:156+(28*2), Y2: (156+(28*2)+ 28) },
	{ X1: 30, X2: (30+ 72), Y1:156+(28*3), Y2: (156+(28*3)+ 28) },
	{ X1: 30, X2: (30+ 72), Y1:156+(28*4), Y2: (156+(28*4)+ 28) },
	{ X1: 30, X2: (30+ 72), Y1:156+(28*5), Y2: (156+(28*5)+ 28) },
	{ X1: 30, X2: (30+ 72), Y1:156+(28*6), Y2: (156+(28*6)+ 80) },
  ];
  var XPG_Primer_Pos = [
	{ X1: 11, X2: (11+ 188), Y1:36+(40*1), Y2: (70+(40*1)+ 40) },//LeftSide
	{ X1: 11, X2: (11+ 188), Y1:36+(40*2), Y2: (70+(40*2)+ 40) },
	{ X1: 11, X2: (11+ 188), Y1:36+(40*3), Y2: (70+(40*3)+ 40) },
	{ X1: 11, X2: (11+ 188), Y1:36+(40*4), Y2: (70+(40*4)+ 40) },
	{ X1: 11, X2: (11+ 188), Y1:36+(40*5), Y2: (70+(40*5)+ 40) },
	{ X1: 11, X2: (11+ 188), Y1:36+(40*6), Y2: (70+(40*6)+ 40) },

	{ X1: 11, X2: (11+ 188), Y1:36+(40*6), Y2: (70+(40*6)+ 40) },//RightSide
	{ X1: 11, X2: (11+ 188), Y1:36+(40*5), Y2: (70+(40*5)+ 40) },
	{ X1: 11, X2: (11+ 188), Y1:36+(40*4), Y2: (70+(40*4)+ 40) },
	{ X1: 11, X2: (11+ 188), Y1:36+(40*3), Y2: (70+(40*3)+ 40) },
	{ X1: 11, X2: (11+ 188), Y1:36+(40*2), Y2: (70+(40*2)+ 40) },
	{ X1: 11, X2: (11+ 188), Y1:36+(40*1), Y2: (70+(40*1)+ 40) },

	{ X1: 80, X2: (80+ 50) , Y1:20, Y2: (20+ 210) },//Scroll

  ];

  var A08s_Pos = [
	{ X1: 11, X2: (11+ 188), Y1:36+(40*1), Y2: (70+(40*1)+ 40) },
	{ X1: 11, X2: (11+ 188), Y1:36+(40*1), Y2: (70+(40*2)+ 40) }
  ]
